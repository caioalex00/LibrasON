    ...
    <body>
        ...
        <div class="uk-navbar-container uk-margin borda-principal" style="margin: 0" uk-navbar>
            <div class="uk-navbar-left">
                ...
                <ul class="uk-navbar-nav" id="navbarWEB">
                    <li class="uk-active">
        ...
        <!-- Carrosel -->
        <div id="carrosel" class="uk-position-relative uk-visible-toggle uk-light borda-principal" tabindex="-1" uk-slideshow="ratio: 12:3; animation: scale; autoplay: true; autoplay-interval: 5000">
        ...
        <div class="InformacoesTelaPrincipal SombraAoRedor">
            <center>
                <img class="logoPrincipal" src="img/Logo.png" width="250" alt="Logo oficial LibraON">
        ...
        <div class="uk-background-cover uk-overflow-hidden uk-light uk-flex uk-flex-top" style="background-image: url('img/Apresentacao2.png'); min-height: 800px">
            <div class="uk-text-center uk-margin-auto uk-margin-auto-vertical" style="width: 80%">
                <h1 style="margin-bottom: 40px;" class="Titulos"> O QUE OFEFERECEMOS </h1>
                
                <!-- Apresentação do website Na forma WEB -->
                
                <div id="apresentacao-web" uk-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; viewport: 0.5;" lass="uk-container uk-container-large">
                ...
                <div class="apresentacao-mobile-d" uk-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; viewport: 0.5;" lass="uk-container uk-container-large">
                    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
                        <div>
                            <div  style="height: auto !important" class="uk-card uk-card-default CorrecaoDeTamanho">
                                <div class="uk-card-media-top">
                                    <img src="images/light.jpg" alt="">
                                </div>
                                <div class="uk-card-body">
                ...
                <div class="apresentacao-mobile-d" uk-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; viewport: 0.5;" lass="uk-container uk-container-large">
                    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
                        <div>
                            <div style="height: auto !important; margin-top: 10px;" class="uk-card uk-card-default CorrecaoDeTamanho">
                                <div class="uk-card-media-top">
                                    <img src="images/light.jpg" alt="">
                                </div>
                                <div class="uk-card-body">
                ...
                <div class="apresentacao-mobile-d" uk-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; viewport: 0.5;" lass="uk-container uk-container-large">
                    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
                        <div>
                            <div style="height: auto !important; margin-top: 10px; margin-bottom: 20px" class="uk-card uk-card-default CorrecaoDeTamanho">
                                <div class="uk-card-media-top">
                                    <img src="images/light.jpg" alt="">
                                </div>
                                <div class="uk-card-body">
        ...
        <div class=" InformacoesTelaPrincipal uk-background-cover uk-overflow-hidden uk-light uk-flex uk-flex-top" style="background-image: url('img/Apresentacao3.png'); height: 1200px">
            <div class="uk-text-center uk-margin-auto uk-margin-auto-vertical" style="width: 80%">
                ...
                <hr class="uk-divider-icon display-none">

                <div id="slider-mobile"  uk-slider="autoplay: true; autoplay-interval: 1400" class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider>
    ...
    <!-- Modal de Cadastro -->
        ...
        <div id="modal-cadastro" class="uk-modal-full" uk-modal>
            <div class="uk-modal-dialog">
                ...
                <div id="cadastro-web" class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
        ...
        <div id="offcanvas-push" uk-offcanvas="mode: push; overlay: true">
            <div class="uk-offcanvas-bar">
                <ul class="uk-nav uk-nav-default">
                    <li class="uk-nav-header">Opções de Entrada</li>
                    <li class="uk-nav-divider"></li>
                    <li><a href="#modal-cadastro" uk-toggle><span class="uk-margin-small-right" uk-icon="icon: sign-in"></span> Cadastro</a></li>
                    <li><a href="#modal-login" uk-toggle><span class="uk-margin-small-right" uk-icon="icon: user"></span> Entrar</a></li>
                    <li class="uk-nav-divider"></li>
                </ul>
            </div>
        </div>
