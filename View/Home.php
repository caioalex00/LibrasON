                ...
                <div class="uk-width-expand@m Tamanho-Home-PrimeiraArea">
                    <div class="uk-card uk-card-default uk-card-body Tamanho-Home-PrimeiraArea Borda-Card sombraCaixa">
                        <div class="uk-text-center" uk-grid>
                          ...
                          <div class="uk-width-1-6@m display-none" style="height: 30px">
                              <div class="uk-divider-vertical" style="height: 60px"></div>
                          </div>
                          <div class="uk-width-expand@m">
                            <h3 class="uk-card-title TituloCard display-none" style="margin-bottom: 0">Funcionalidades da Plataforma</h3>
                            <h5 class="TituloCard display-none" style="margin-top: 0">Todas as funções principais abaixo</h5>
                          </div>
                        </div>
                        ...
                        <div class="uk-child-width-expand@s Cards-Funcoes" uk-grid>
                            ...
                            <div class="atalhos-mobile-adapt">
                        ...
                        <div class="uk-child-width-expand@s Cards-Funcoes card-mobile-adpt" uk-grid>
        ...
        <div id="offcanvas-push" uk-offcanvas="mode: push; overlay: true">
            <div class="uk-offcanvas-bar">
                <ul class="uk-nav uk-nav-default">
                    ...
                    <li class="uk-nav-divider"></li>
                    <li class="uk-active"><a href="" uk-toggle><span class="uk-margin-small-right" uk-icon="icon: home"></span>Início</a></li>
